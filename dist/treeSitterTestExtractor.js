 ...
 */
export const LEAF_TEST_GLOBALS = new Set([
    'it',
    'test',
    'it.only',
    'test.only',
 ...
 */
export const STRUCTURAL_TEST_GLOBALS = new Set([
    'describe',
    'describe.only',
    'describe.skip',
    'xdescribe',
 ...
 */
function resolveDescribeChain(callNode) {
    const chain = [];
 ...
 */
function extractCallbackNode(callNode) {
    const argsNode = callNode.childForFieldName('arguments');
    if (!argsNode)
        return null;
 ...
 * substring match.
 */
export function extractTestCaseDefinitions(rootNode, definitions) {
            ...
            if (calleeName !== null) {
                ...
                if (isLeaf || isStructural) {
                    ...
                    if (rawLabel !== null) {
                        ...
                        const chainPrefixed = describeChain.length > 0
                        ...
                        const isAsync = callbackNode !== null &&
...
//# sourceMappingURL=treeSitterTestExtractor.js.map